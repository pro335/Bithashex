     ...
     render() {
        return(
            <div className="SellForm">
                ...
                <div className="row">
                    <span className="SellCurrencyLabel SellPaymentMethod">Payment Method</span>
                </div>
                <div className="row SellSendDiv">
                ...
                <div className="row">
                    <div className="col-xl-7">
                        <span className="monthlyLimitLabel ExchangeSellMonthlyLimitLabel">Monthly Limit</span>
                    </div>
