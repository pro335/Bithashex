...
class WelcomeWhatwedoItemCard extends Component {
	...
	render() {
		...
		return (
			<div className={classnames(colClasses ? colClasses : '', { 'd-block': !collapse })}>
				<div className={classnames(`rct-block-WelcomeWhatwedoItemCard ${customClasses ? customClasses : ''}`, { 'd-none': close })}>
					{heading &&
...
export default WelcomeWhatwedoItemCard;
