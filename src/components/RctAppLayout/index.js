		...
		return (
			<div className="app">
				<div className="app-main-container">
					<Tour />
					<Sidebar
						sidebar={this.props.authUser.isLogin ? this.renderSidebar() : null}
						open={this.props.authUser.isLogin && windowWidth > 450 ? true : false}//{windowWidth <= 1199 ? navCollapsed : false}
